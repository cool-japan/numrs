...
fn test_vonmises_seed_issue() {
    ...
    assert_eq!(normal1.to_vec(), normal2.to_vec(), "Normal sequences should be identical");
    ...
    assert_eq!(vonmises1.to_vec(), vonmises2.to_vec(), "Vonmises sequences should be identical");
}
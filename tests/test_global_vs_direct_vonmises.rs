...
fn test_global_vs_direct_vonmises() {
    ...
    assert_eq!(global1.to_vec(), global2.to_vec(), "Global vonmises should be reproducible");
    ...
    assert_eq!(direct1.to_vec(), direct2.to_vec(), "Direct vonmises should be reproducible");

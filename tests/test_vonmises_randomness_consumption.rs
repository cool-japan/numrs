...
fn test_vonmises_randomness_consumption() {
    ...
    assert_eq!(vm1.to_vec(), vm2.to_vec(), "Vonmises sequences should be identical");
    assert_eq!(norm1.to_vec(), norm2.to_vec(), "Normal sequences should be identical");
    ...
    assert_eq!(vm_high1.to_vec(), vm_high2.to_vec(), "High kappa vonmises should be identical");
    assert_eq!(norm_after1.to_vec(), norm_after2.to_vec(), "Normal after high kappa vonmises should be identical");
}
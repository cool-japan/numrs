...
mod gpu_reduction_tests {
    ...
    fn test_sum_f32() -> Result<()> {
        ...
        assert!((gpu_sum - expected_sum).abs() < 1e-6, 
                "Sum mismatch: expected {}, got {}", expected_sum, gpu_sum);
    ...
    fn test_sum_f64() -> Result<()> {
        ...
        assert!((gpu_sum - expected_sum).abs() < 1e-12, 
                "Sum mismatch: expected {}, got {}", expected_sum, gpu_sum);
    ...
    fn test_mean_f32() -> Result<()> {
        ...
        assert!((gpu_mean - expected_mean).abs() < 1e-6, 
                "Mean mismatch: expected {}, got {}", expected_mean, gpu_mean);
    ...
    fn test_mean_f64() -> Result<()> {
        ...
        assert!((gpu_mean - expected_mean).abs() < 1e-12, 
                "Mean mismatch: expected {}, got {}", expected_mean, gpu_mean);
    ...
    fn test_max_f32() -> Result<()> {
        ...
        assert!((gpu_max - expected_max).abs() < 1e-6, 
                "Max mismatch: expected {}, got {}", expected_max, gpu_max);
    ...
    fn test_max_f64() -> Result<()> {
        ...
        assert!((gpu_max - expected_max).abs() < 1e-12, 
                "Max mismatch: expected {}, got {}", expected_max, gpu_max);
    ...
    fn test_min_f32() -> Result<()> {
        ...
        assert!((gpu_min - expected_min).abs() < 1e-6, 
                "Min mismatch: expected {}, got {}", expected_min, gpu_min);
    ...
    fn test_min_f64() -> Result<()> {
        ...
        assert!((gpu_min - expected_min).abs() < 1e-12, 
                "Min mismatch: expected {}, got {}", expected_min, gpu_min);
    ...
    fn test_large_array_reductions() -> Result<()> {
        ...
        assert!((gpu_sum - expected_sum).abs() / expected_sum < 1e-5, 
                "Large array sum mismatch: expected {}, got {}", expected_sum, gpu_sum);
        
        // Test mean
        let gpu_mean = gpu::mean_f32(&gpu_array)?;
        let expected_mean = (size - 1) as f32 / 2.0;
        assert!((gpu_mean - expected_mean).abs() < 1e-3, 
                "Large array mean mismatch: expected {}, got {}", expected_mean, gpu_mean);
        
        // Test max
        let gpu_max = gpu::max_f32(&gpu_array)?;
        let expected_max = (size - 1) as f32;
        assert!((gpu_max - expected_max).abs() < 1e-6, 
                "Large array max mismatch: expected {}, got {}", expected_max, gpu_max);
        
        // Test min
        let gpu_min = gpu::min_f32(&gpu_array)?;
        let expected_min = 0.0f32;
        assert!((gpu_min - expected_min).abs() < 1e-6, 
                "Large array min mismatch: expected {}, got {}", expected_min, gpu_min);

...
fn bench_memory_optimization(c: &mut Criterion) {
    ...
    for size in sizes {
        ...
        group.bench_with_input(
            BenchmarkId::new("is_c_contiguous", size),
            &size,
            |b, _| {
                b.iter(|| {
        ...
        group.bench_with_input(
            BenchmarkId::new("to_c_layout", size),
            &size,
            |b, _| {
                b.iter(|| {

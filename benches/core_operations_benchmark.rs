...
use numrs2::stats;
use numrs2::memory_optimize::cache_layout::{optimize_layout, LayoutStrategy, calculate_optimal_block_size};
use numrs2::simd;
...
fn bench_array_indexing(c: &mut Criterion) {
    ...
    for size in sizes {
        ...
        group.bench_with_input(
            ...
            &size,
            |b, &size| {
                let indices: Vec<(usize, usize)> = (0..1000)
                    .map(|i| (i % size, (i * 7) % size))
                    .collect();
                b.iter(|| {
                    let mut sum = 0.0;
                    for &(i, j) in &indices {
...
fn bench_broadcasting(c: &mut Criterion) {
    ...
    for size in sizes {
        ...
        group.bench_with_input(
            BenchmarkId::new("scalar_array_add", size),
            &size,
            |b, _| {
                b.iter(|| {
...
fn bench_cache_optimization(c: &mut Criterion) {
    ...
    for size in sizes {
        ...
        group.bench_with_input(
            BenchmarkId::new("row_major_layout", size),
            &size,
            |b, _| {
                b.iter(|| {
        ...
        group.bench_with_input(
            BenchmarkId::new("morton_layout", size),
            &size,
            |b, _| {
        ...
        group.bench_with_input(
            BenchmarkId::new("blocked_layout", size),
            &size,
            |b, _| {
                let mut data_copy = data.clone();
...
fn bench_axis_operations(c: &mut Criterion) {
    ...
    for size in sizes {
        ...
        group.bench_with_input(
            BenchmarkId::new("sum_axis_0", size),
            &size,
            |b, _| {
                b.iter(|| {
        ...
        group.bench_with_input(
            BenchmarkId::new("sum_axis_1", size),
            &size,
            |b, _| {
                b.iter(|| {
        ...
        // Mean along axes
        group.bench_with_input(
            BenchmarkId::new("mean_axis_0", size),
            &size,
            |b, _| {
                b.iter(|| {
        ...
        group.bench_with_input(
            BenchmarkId::new("mean_axis_1", size),
            &size,
            |b, _| {
                b.iter(|| {
...
fn bench_simd_performance(c: &mut Criterion) {
    ...
    for size in sizes {
        ...
        // SIMD addition
        group.bench_with_input(
            BenchmarkId::new("simd_add_f64", size),
            &size,
            |b, _| {
                b.iter(|| {
        ...
        // SIMD dot product
        group.bench_with_input(
            BenchmarkId::new("simd_dot_f64", size),
            &size,
            |b, _| {
                b.iter(|| {
        ...
        // FMA operations
        group.bench_with_input(
            BenchmarkId::new("simd_fma_f64", size),
            &size,
            |b, _| {
                b.iter(|| {
...
fn bench_array_shapes(c: &mut Criterion) {
    ...
    for shape in shapes {
        ...
        group.bench_with_input(
            BenchmarkId::new("sum", &shape_name),
            &shape_name,
            |b, _| {
                b.iter(|| {
                    let result = stats::sum(&arr, None).unwrap();

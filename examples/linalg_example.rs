...
fn main() -> Result<()> {
    ...
    println!("Reciprocal condition number: {}", well_conditioned.rcond().unwrap_or(f64::NAN));
    println!("Is well-conditioned: {}", well_conditioned.is_well_conditioned().unwrap_or(false));

...
fn main() -> Result<()> {
    ...
    println!("{}", array3d.index(&[IndexSpec::Index(0), IndexSpec::All, IndexSpec::All])?);
    println!("Second slice (array3d[1]):");
    println!("{}", array3d.index(&[IndexSpec::Index(1), IndexSpec::All, IndexSpec::All])?);
    ...
    println!("{}", moved.index(&[IndexSpec::Index(0), IndexSpec::All, IndexSpec::All])?);
    println!("Second slice (moved[1]):");
    println!("{}", moved.index(&[IndexSpec::Index(1), IndexSpec::All, IndexSpec::All])?);
